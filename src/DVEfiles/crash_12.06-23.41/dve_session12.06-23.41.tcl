...
# DVE full session
# Saved on Wed Dec 6 23:41:30 2017
# Designs open: 1
...
#<Session mode="Full" path="/home/jhazel/ASIC_Design/src/DVEfiles//crash_12.06-23.41/dve_session12.06-23.41.tcl" type="Debug">
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 105} {height 712} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 105} {height 712} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_sg_addsignal -group "$_session_group_1" { test.Cout test.N test.S test.total test.intCout }
gui_set_radix -radix {decimal} -signals {Sim:test.N}
gui_set_radix -radix {twosComplement} -signals {Sim:test.N}
gui_set_radix -radix {binary} -signals {Sim:test.total}
gui_set_radix -radix {unsigned} -signals {Sim:test.total}
...
gui_open_source -id ${Source.1}  -replace -active test /home/jhazel/ASIC_Design/src/../src/compressor_5_3.v
...
gui_wv_zoom_timerange -id ${Wave.1} 0 34
gui_list_add_group -id ${Wave.1} -after {New Group} {test}
gui_list_select -id ${Wave.1} {test.total }
