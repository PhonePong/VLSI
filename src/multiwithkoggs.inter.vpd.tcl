...
# DVE full session
# Saved on Fri Dec 8 00:36:30 2017
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/home/jhazel/ASIC_Design/src/multiwithkoggs.inter.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{0 214} {1279 1138}}
...
gui_show_window -window ${TopLevel.3} -show_state normal -rect {{550 487} {1049 886}}
...
gui_set_radix -radix enum -signals {Sim:test.M.runningsumMSB}
gui_set_radix -radix enum -signals {Sim:test.M.runningsumLSB}
...
gui_sg_addsignal -group "$_session_group_3" { test.A test.B test.P test.O test.Monitor1 test.Monitor2 test.Monitor3 test.Monitor4 test.Monitor5 test.Monitor6 test.Monitor7 test.Monitor8 test.Monitor9 test.Monitor10 test.Monitor11 test.Monitor12 test.Monitor13 test.Monitor14 test.Monitor15 test.Monitor16 test.Monitor17 test.Monitor18 test.o test.N }
...
gui_wv_zoom_timerange -id ${Wave.1} 2 6
...
gui_list_select -id ${Wave.1} {test.M.runningsumMSB test.M.runningsumLSB }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group test  -item {test.M.e[0]} -position below

gui_marker_move -id ${Wave.1} {C1} 4
gui_view_scroll -id ${Wave.1} -vertical -set 23
